...
The current system шрифтов предоставляет простой pipeline:
...
> > Note: this document describes the current FontService implementation in the Sample. It does not mean that the main library exposes a separate public font service.
