...
Namespace VBImGuiDx9.Backends.Direct3D9
    ...
    Public NotInheritable Class Dx9IndexBuffer
        ...
        Public Sub New(
            ...
            ' Vortice 3.8.3:
            ' CreateIndexBuffer(uint, Usage, Boolean, Pool)
            _buffer =
                device.NativeDeviceInternal.CreateIndexBuffer(
                    CUInt(sizeInBytes),
                    usage,
                    True,
                    Dx9.Pool.Default)
        ...
        Public ReadOnly Property NativeBuffer As Dx9.IDirect3DIndexBuffer9
            Get
                ThrowIfDisposed()
                Return _buffer
            End Get
